...
const publicScripts = require('./public-unrestricted/app.scripts.json')
...
const source = {
    ...
    public: {
        src: [
            // bootstrap angular
            'public-unrestricted/modules/main.js',

            // main module
            'public-unrestricted/modules/app.js',

            // module files
            'public-unrestricted/modules/**/module.js',
...
gulp.task('watch', ['admin-js' ,'public-js' ], function () {
...
gulp.task('dev', ['vendor-admin', 'vendor-public', 'admin-js', 'public-js', 'watch'])
...
gulp.task('prod', ['vendor-admin', 'vendor-public', 'admin-js', 'public-js'])
